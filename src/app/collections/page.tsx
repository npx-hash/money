    ...
    <div className="page-shell space-y-8">
      ...
      {groups.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center">
          <p className="font-semibold text-slate-900">No active collections yet.</p>
          <p className="mt-1 text-sm text-slate-600">Enable products from admin to publish them here.</p>
          <Link href="/admin/products" className="mt-4 inline-flex text-sm font-semibold text-emerald-700 hover:underline">
            Open product controls
          </Link>
        </div>
      ) : (
